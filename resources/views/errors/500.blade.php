        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8 text-center">
                    <h1 style="font-size: 120px; font-weight: 700; color: #4a57ca; line-height: 1;">500</h1>
                    <h3 class="mb-3">Internal Server Error</h3>
                    <p class="mb-4">Something went wrong on our end. Please try again later or contact support if the
                        problem persists.</p>
