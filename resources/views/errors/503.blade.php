        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8 text-center">
                    <h1 style="font-size: 120px; font-weight: 700; color: #4a57ca; line-height: 1;">503</h1>
                    <h3 class="mb-3">Service Unavailable</h3>
                    <p class="mb-4">We are currently performing maintenance. Please check back shortly.</p>
                    <a href="{{ url('/') }}" class="btn style1">Try Again</a>
                </div>
            </div>
        </div>
    </section>
